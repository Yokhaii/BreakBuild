--[=[
	LockedBlueprintCard Component
	Displays a locked blueprint with darkened styling and lock overlay
]=]
...
local function LockedBlueprintCard(props, hooks)
		...
		for i, material in ipairs(props.Materials) do
			materialElements["Material_" .. i] = Roact.createElement("Frame", {
				...
				Icon = Roact.createElement("ImageLabel", {
					...
					ImageColor3 = Config.MaterialIconColor,
					ZIndex = baseZIndex + 4,
				}, {
					UIAspectRatioConstraint = Roact.createElement("UIAspectRatioConstraint", {
						AspectRatio = 1,
	...
	return Roact.createElement("Frame", {
		...
		-- Locked overlay
		LockedOverlay = Roact.createElement("Frame", {
			Size = UDim2.fromScale(1, 1),
			Position = UDim2.fromScale(0.5, 0.5),
			AnchorPoint = Vector2.new(0.5, 0.5),
			BackgroundColor3 = Config.OverlayColor,
			...
			LockText = Roact.createElement(FancyText, {
				...
				Position = UDim2.fromScale(0.5, 0.5),
				AnchorPoint = Vector2.new(0.5, 0.5),
				TextColor3 = Config.LockTextColor,
				StrokeColor = Config.LockTextStrokeColor,
				StrokeThickness = Config.LockTextStrokeThickness,
...
LockedBlueprintCard = RoactHooks.new(Roact)(LockedBlueprintCard)
return LockedBlueprintCard
