--[=[
	StoneCutter Application
	Mounted as a child of the Backpack's InventoryFrame when CurrentFrame == "StoneCutter".
...
local function StoneCutterApplication(props, hooks)
	...
	return Roact.createFragment({
		StoneCutterPanel = Roact.createElement(PanelFrame, {
			Name = "StoneCutterPanel",
		...
		StoneCutterTopPanel = Roact.createElement(TopPanelFrame, {
			Name = "StoneCutterTopPanel",
...
StoneCutterApplication = RoactHooks.new(Roact)(StoneCutterApplication)
return StoneCutterApplication
