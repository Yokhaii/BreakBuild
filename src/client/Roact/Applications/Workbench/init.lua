--[=[
	...
	Mounted as a child of the Backpack's InventoryFrame when CurrentFrame == "Workbench".
...
local function WorkbenchApplication(props, hooks)
	...
	return Roact.createFragment({
		WorkbenchPanel = Roact.createElement(PanelFrame, {
			Name = "WorkbenchPanel",
		...
		WorkbenchTopPanel = Roact.createElement(TopPanelFrame, {
			Name = "WorkbenchTopPanel",
...
WorkbenchApplication = RoactHooks.new(Roact)(WorkbenchApplication)
